...
* Иногда издательский софт для работы с PDF отказывается редактировать PDF (а издателям бывает нужно) из-за неверно выставленных при генерации атрибутов.
  По опыту, это [исправляется следующим образом](https://superuser.com/a/367187/2068595): `pdftk in.pdf output out.pdf allow AllFeatures`
